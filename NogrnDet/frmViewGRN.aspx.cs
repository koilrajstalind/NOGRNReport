...
public partial class _Default : System.Web.UI.Page
{
    ...
    public string sts, grncustname;
    public string agegrp, custgrp, chkval, grnchk, grnck;
    public decimal sumFooterValue = 0;
    protected void Page_Load(object sender, EventArgs e)
    {
        grnchk = chkval = Session["chk"].ToString();
        grncustname = Session["nogrn"].ToString();
    ...
    private void BindGRNDet()
    {
        try
        {
            ...
            {
                dsName = objMaster.fnLoadGRN(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, 0, string.Empty, 0, 0, 0, 0, 0, string.Empty, string.Empty, string.Empty, 0, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, Session["nogrn1"].ToString(), string.Empty, string.Empty, string.Empty, "GetgrnEmptyValDet");
            }
            else if (chkval.Equals("nochk"))
            {
                dsName = objMaster.fnLoadGRN(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, 0, Session["agegrp"].ToString(), 0, 0, 0, 0, 0, string.Empty, string.Empty, string.Empty, 0, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, Session["custgrp"].ToString(), string.Empty, string.Empty, "GetgrnCellEmptyValDet");
            }
            else if (chkval.Equals("ftrchk"))
            {
                dsName = objMaster.fnLoadGRN(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, 0, Session["agegrp"].ToString(), 0, 0, 0, 0, 0, string.Empty, string.Empty, string.Empty, 0, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, "GetgrntotEmptyValDet");
            }
            else if (chkval.Equals("ftrtotchk"))
            {
                dsName = objMaster.fnLoadGRN(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, 0, string.Empty, 0, 0, 0, 0, 0, string.Empty, string.Empty, string.Empty, 0, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, "GetnogrnEmptyVal");
            }
            else
            {
   ...
   /* protected void OnPaging(object sender, GridViewPageEventArgs e)
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Session["nogrn"] = grncustname.ToString();
