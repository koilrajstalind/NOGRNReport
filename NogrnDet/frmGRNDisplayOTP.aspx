<%@ Page Title="NO GRN (With and Without POD/Bill of Lading)" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="frmGRNDisplayOTP.aspx.cs" Inherits="_Default" %>
...
<br /><br />
    <div id="frmDiv1" runat="server">
    <table Runat="Server" align="center" border="1" width=20% background="white" style="border-radius:2px;2px;2px;2px;">
        <tr Runat="Server" >
			<td Runat="Server" valign="center" align="left" style="padding-left:4px;" width=30% >Enter OTP&nbsp;</font><font face=verdana size=1 color=red>*&nbsp;</font></td>
			<td Runat="Server" valign="center" align="left" style="padding-left:4px" width=30%>
             <asp:TextBox name="txtotp" id="txtotp" runat="Server" onKeyDown="return IsNumeric(event);"  MaxLength="4" class="form-control" Width="95px" style="-webkit-text-security: circle;"/>
          ...
          <tr>
              <td align="center" valign="center" width=30%>	
                ...
                <asp:Button Runat="server" Name="BtnOTP" Text="Submit" ID="BtnOTP" OnClick="BtnOTP_Click" class="btn btn-success" ForeColor="White"/></td>
         <td align="center" valign="center" width=30%>	
                <asp:Button Runat="server" name="Reset" Text="Reset" value="Reset" class="btn btn-danger" style="cursor:hand;width:60px;color:white;" />
...
<div id="NOGRNDIV1" Runat="Server" visible="false">
     
<br />
<div class="table-responsive" id="NOGRN1" Runat="Server" visible="false"> 
    ...
    <div id="gridcontainr" style="padding-left:15px; overflow-x:hidden;overflow-y:scroll; max-height:175px;height:auto;max-width:98%; width:auto;">
        <asp:GridView ID="grdnogrn" runat="server" CssClass="table-condensed1" ShowHeader="false" emptydatatext="No data available." cellpadding="5" cellspacing="2" OnRowDataBound="grdnogrn_RowDataBound" Width="95%"
            AutoGenerateColumns="False" OnRowCommand="grdnogrn_RowCommand" ShowFooter="true" OnSelectedIndexChanging="grdnogrn_SelectedIndexChanging" Visible="false">
            <Columns>                         
...
<div class="table-responsive" id="gridcontainrmiddle1" Runat="Server" visible="false"> 
    <div style="height:30px; padding-left:15px;"> 
    <table style="font-family:Arial, Helvetica, sans-serif;font-size:medium;color:white;width:92%;">
            <tr style="background-color:#507CD1;font-family:Arial, Helvetica, sans-serif;font-size:medium;font-weight:bold;">
    ...
    <br />
    <div id="TotalNoGrn1" Runat="Server" visible="false"> 
        <table style="font-family:Arial, Helvetica, sans-serif;font-size:medium;color:white;width:92%;" >
            <tr style="background-color:#507CD1;font-family:Arial, Helvetica, sans-serif;font-size:medium;font-weight:bold;">
